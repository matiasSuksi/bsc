...
Seuraavaksi perustellaan miksi segmentoidun pinon aikaisemmin mainitut heikkoudet häviävät.
~\\
\begin{itemize}
    ...
    \item{Koodikannan kontrolli: Hyvin usein kehittäjillä on täysi pääsy koko ohjelman lähdekoodiin, jolloin segmentoitu pino on helppo implementoida koko järjestelmään eikä kehittäjän tarvitse tehdä toteutusta, joka toimisi yhdessä jatkuvan pinon kanssa. Tilanteissa, jossa ulkoinen oheislaitteiden toimittaja tarjoaa binäärikirjastoja laitteilleen, on helppoa tarjoata vain segmentoidulla pinolla käännetty versio.}\cite{bsstes@2023}
